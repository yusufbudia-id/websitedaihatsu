        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <img
                // Menggunakan car.mainImage jika ada, atau fallback ke gambar pertama di gallery
                src={car.mainImage || car.gallery?.[0] || car.images?.[0]} 
                alt={car.name}
            ...
            <div>
              ...
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                {car.name} hadir sebagai partner perjalanan yang memahami kebutuhan Anda.
                Dirancang untuk kenyamanan, efisiensi, dan gaya hidup modern, mobil ini
                menjadi pilihan ideal baik untuk aktivitas harian maupun perjalanan
                bersama keluarga.
              </p>

              <p className="text-lg text-gray-700 leading-relaxed mb-8">
                Dengan desain yang stylish, konsumsi bahan bakar yang efisien, serta
                fitur keselamatan yang lengkap, {car.name} memberikan rasa percaya diri
