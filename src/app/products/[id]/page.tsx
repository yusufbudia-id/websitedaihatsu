...
{/* Hero Section - Perubahan ke Tema Dark Elegan */}
      <section className="py-16 bg-[#1A1A1A] text-white"> {/* Ganti bg-white ke Charcoal */}
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <p className="text-xl text-gray-300 leading-relaxed font-light">
                  ...
                  Dirancang untuk kenyamanan, efisiensi, dan gaya hidup modern.
                </p>
                <div className="h-1 w-20 bg-red-600"></div> {/* Aksen garis merah */}
                <p className="text-lg text-gray-400 leading-relaxed italic border-l-2 border-gray-700 pl-4">
                  "{car.story.quote}"
                </p>
              </div>
